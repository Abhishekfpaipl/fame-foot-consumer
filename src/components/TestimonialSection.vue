        ...
        <div class="w-100 d-block">
            ...
            <div>
                <!-- <div class="text d-flex justify-content-center text-center">
                    <p class="w-75 fs-4">" {{ getSelectedReviewText.value }} "</p>
                    <div class="additional-info">
                        <p><strong>Name:</strong> {{ getSelectedReviewText.name }}</p>
                        <p><strong>Post:</strong> {{ getSelectedReviewText.post }}</p>
                        <p><strong>Rating:</strong> {{ getSelectedReviewText.user_rating }}</p>
                        <p><strong>Date:</strong> {{ getSelectedReviewText.date }}</p>
                    </div>
                </div> -->
